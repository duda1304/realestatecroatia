  ...
  return (
    <section className="container-fluid p-2" >
      <div className="row gx-2">
        <article className="col-3 mt-3" onClick={() => handleNavigation('/top-20')} >
        ...
        <article className="col-3 mt-3" onClick={() => handleNavigation('/vendita-prima-fila-dal-mare')}>
          <div className="card h-100 rounded position-relative border-0 shadow-sm">
