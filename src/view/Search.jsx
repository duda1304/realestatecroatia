...
export default function Search(props) {
    ...
    const handleSubmit = () => {
        props.setSearchValues({'city' : city})
        props.setTitle(city)
        navigate('/cerca')
    }
            ...
            <div className="card p-3 w-100 mb-2 bg-white rounded border-0 search-card">
                ...
                <div className="col-12 d-flex flex-row">
                    <div className="col flex-1 position-relative">
                        <div className="input-group">
                            ...
                            <div className="input-suggestion-wrapper">
                                <input type="text" className="form-control border-0 me-5 rounded-end w-100" placeholder="Scrivi qui..." aria-label="Search Input" onChange={handleChange} value={inputValue}/>
                                {showSuggestions && filteredSuggestions.length > 0 && (
                                    ...
                                    {filteredSuggestions.map((suggestion, index) => (
                                        ...
                                        onClick={() => {handleSelectSuggestion(suggestion); setCity(suggestion)}}
                                        >
                                        {suggestion}
                                        </li>
                                    ))}
                    ...
                    <div className="d-flex flex-row">
                        ...
                        <button type="button" className="btn btn-primary border-0 rounded-0" onClick={() => handleSubmit()}>Cerca</button>
                    </div>
                </div>
                </div>
            </div>
